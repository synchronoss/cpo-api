...
insert into cpo_query_text (text_id, sql, description) values ('6ace397e-0a0e-0043-00e4-d0cd3e857349','{?= call sysdate}','ValueObject - Function test');
update cpo_query_text set sql = '{?= call sysdate}', description = 'ValueObject - Function test' where text_id = '6ace397e-0a0e-0043-00e4-d0cd3e857349';
insert into cpo_query_text (text_id, sql, description) values ('b07ebd5c-0a07-2346-00fb-cb7021f181bf','Select * from value_object where id = ?','ValueObject - TestRetrieveObject');
update cpo_query_text set sql = 'Select * from value_object where id = ?', description = 'ValueObject - TestRetrieveObject' where text_id = 'b07ebd5c-0a07-2346-00fb-cb7021f181bf';
insert into cpo_query_text (text_id, sql, description) values ('d2abbeee-0a0e-0045-00ba-6c139775eae1','insert into value_object (id, attr_varchar) values (?,?)','ValueObject - TestRollback');
update cpo_query_text set sql = 'insert into value_object (id, attr_varchar) values (?,?)', description = 'ValueObject - TestRollback' where text_id = 'd2abbeee-0a0e-0045-00ba-6c139775eae1';
insert into cpo_query_text (text_id, sql, description) values ('d329696e-0a0e-0045-00ba-6c13279e1c3e','insert into value_object (id, attr_varchar) values (2,''Test'')','TestSingleRollback1');
update cpo_query_text set sql = 'insert into value_object (id, attr_varchar) values (2,''Test'')', description = 'TestSingleRollback1' where text_id = 'd329696e-0a0e-0045-00ba-6c13279e1c3e';
insert into cpo_query_text (text_id, sql, description) values ('d329975c-0a0e-0045-00ba-6c1397d6e8c9','insert into value_object (id, attr_varchar) values (1,''Test'')','TestSingleRollback2');
update cpo_query_text set sql = 'insert into value_object (id, attr_varchar) values (1,''Test'')', description = 'TestSingleRollback2' where text_id = 'd329975c-0a0e-0045-00ba-6c1397d6e8c9';
insert into cpo_class (class_id, name) values ('b079d2fa-0a07-2346-00fb-cb702782dbc4','org.synchronoss.cpo.jdbc.ValueObject');
insert into cpo_attribute_map (attribute_id, class_id, column_name, attribute, column_type, db_column, db_table,transform_class) values ('b079d354-0a07-2346-00fb-cb7051c25736','b079d2fa-0a07-2346-00fb-cb702782dbc4','ATTR_CHAR','attrChar','CHAR',null,null,null);
...
insert into cpo_query_group (group_id, class_id, type, name) values ('6ace813c-0a0e-0043-00e4-d0cdec32bc22','b079d2fa-0a07-2346-00fb-cb702782dbc4','EXECUTE','TestExecuteObject');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('b079d37c-0a07-2346-00fb-cb708d7950f3','6ace92a5-0a0e-0043-00e4-d0cd9cba8889','1','OUT');
insert into cpo_query_group (group_id, class_id, type, name) values ('b07f0cf8-0a07-2346-00fb-cb701d7f186a','b079d2fa-0a07-2346-00fb-cb702782dbc4','RETRIEVE','TestRetrieveObject');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('b079d30e-0a07-2346-00fb-cb70284b51ce','b07f24d5-0a07-2346-00fb-cb704600a48b','1','IN');
insert into cpo_query_group (group_id, class_id, type, name) values ('d2b1e7f5-0a0e-0045-00ba-6c13136edb10','b079d2fa-0a07-2346-00fb-cb702782dbc4','CREATE','TestRollback');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('b079d30e-0a07-2346-00fb-cb70284b51ce','d2b224fe-0a0e-0045-00ba-6c133cf4fa7a','1','IN');
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('b079d37c-0a07-2346-00fb-cb70993afd00','d2b224fe-0a0e-0045-00ba-6c133cf4fa7a','2','IN');
insert into cpo_query_group (group_id, class_id, type, name) values ('d32c0ca6-0a0e-0045-00ba-6c13efc1e520','b079d2fa-0a07-2346-00fb-cb702782dbc4','CREATE','TestSingleRollback');
