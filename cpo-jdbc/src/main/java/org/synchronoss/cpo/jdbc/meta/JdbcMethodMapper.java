...
public class JdbcMethodMapper implements java.io.Serializable, Cloneable {
  ...
  private static MethodMapper<JdbcMethodMapEntry<?, ?>> initMethodMapper()
    ...
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, byte.class, byte.class, "getByte", "setByte"));
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, Byte.class, byte.class, "getByte", "setByte"));
    mapper.addMethodMapEntry(
    ...
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, int.class, int.class, "getInt", "setInt"));
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, Integer.class, int.class, "getInt", "setInt"));
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, long.class, long.class, "getLong", "setLong"));
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, Long.class, long.class, "getLong", "setLong"));
    mapper.addMethodMapEntry(
    ...
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC, URL.class, URL.class, "getURL", "setURL"));
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_BASIC,
            boolean.class,
    ...
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_STREAM,
            InputStream.class,
            InputStream.class,
            "getBlob",
            "setBinaryStream"));
    mapper.addMethodMapEntry(
        makeJdbcMethodMapEntry(
            JdbcMethodMapEntry.METHOD_TYPE_READER,
            Reader.class,
            Reader.class,
            "getClob",
            "setCharacterStream"));
  ...
  private static <J, D> JdbcMethodMapEntry<?, ?> makeJdbcMethodMapEntry(
      int methodType,
      Class<J> javaClass,
    ...
    return new JdbcMethodMapEntry<>(
        methodType, javaClass, datasourceMethodClass, rsGetter, bsSetter, csGetter, csSetter);
  }
