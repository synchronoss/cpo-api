...
public class XaResourceTest extends TestCase {
  ...
  private CpoXaAdapter cpoXaAdapter1 = null;
  private CpoXaAdapter cpoXaAdapter2 = null;
  ...
  public void setUp() {
    ...
    try {
      ...
      cpoXaAdapter1 = CpoAdapterFactoryManager.getCpoXaAdapter(JdbcStatics.ADAPTER_CONTEXT_JDBC);
      cpoXaAdapter2 = CpoAdapterFactoryManager.getCpoXaAdapter(JdbcStatics.ADAPTER_CONTEXT_JDBC);
