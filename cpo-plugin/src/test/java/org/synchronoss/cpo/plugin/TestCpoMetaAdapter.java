...
/** A minimal concrete meta adapter so plugin tests can load meta XML without a datastore. */
public class TestCpoMetaAdapter extends AbstractCpoMetaAdapter {
