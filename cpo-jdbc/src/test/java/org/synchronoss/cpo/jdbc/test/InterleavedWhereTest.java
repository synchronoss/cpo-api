...
public class InterleavedWhereTest {
  ...
  public void setUp() {
    ...
    ValueObject vo1 = ValueObjectFactory.createValueObject(75, className);
    vo1.setAttrVarChar("Test");
    vo1.setAttrBit(true);
    al.add(vo1);

    ValueObject vo3 = ValueObjectFactory.createValueObject(76, className);
    vo3.setAttrVarChar("Test");
    vo3.setAttrBit(true);
    al.add(vo3);

    ValueObject vo5 = ValueObjectFactory.createValueObject(77, className);
  ...
  public void testInterleavedInWhereCollection() {
    ...
    try {
      ValueObject valObj = ValueObjectFactory.createValueObject(75, className);
      ...
      CpoWhere cw = cpoAdapter.newWhere(CpoWhere.LOGIC_AND, ValueObject.ATTR_ID, CpoWhere.COMP_IN, inColl);
