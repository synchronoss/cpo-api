...
INSERT INTO TEST_cpo_query(query_id, group_id, seq_no, userid, createdate, sql_text, description)
  VALUES('04a8541c-0a0e-0090-0049-57c7ffebb167', '04a83022-0a0e-0090-0049-57c7f3284546', 0, NULL, NULL, 'select * from value_object where id = ? for update', 'ValueObject - SelectForUpdate');
INSERT INTO TEST_cpo_query(query_id, group_id, seq_no, userid, createdate, sql_text, description)
  VALUES('04aa5200-0a0e-0090-0049-57c7f2036125', '04aa3721-0a0e-0090-0049-57c7cf24bc3a', 0, NULL, NULL, 'select * from value_object where id = ? for update', 'ValueObject - SelectForUpdateNoWait');
INSERT INTO TEST_cpo_query(query_id, group_id, seq_no, userid, createdate, sql_text, description)
