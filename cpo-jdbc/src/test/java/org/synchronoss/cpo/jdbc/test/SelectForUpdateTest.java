...
public class SelectForUpdateTest {
  ...
  public void setUp(boolean select4update) {
    ...
    ValueObject vo = ValueObjectFactory.createValueObject(39, className);
    ValueObject vo2 = ValueObjectFactory.createValueObject(38, className);
    try {
  ...
  public void testSelect4UpdateSingleObject() {
    if (isSupportsSelect4Update) {
      ...
      ValueObject vo2 = ValueObjectFactory.createValueObject(39, className);
