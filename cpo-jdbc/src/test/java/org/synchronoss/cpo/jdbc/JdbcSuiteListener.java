...
public class JdbcSuiteListener implements ISuiteListener {
      ...
      try {
        h2Server =
            Server.createTcpServer(
                "-tcpPort", dbPort, "-tcpAllowOthers", "-baseDir", "~/", "-ifNotExists");
        h2Server.start();
      ...
      if (jdbcContainer != null) {
        ...
        TcpProxyConfig config =
            new StaticTcpProxyConfig(
                ...
                jdbcContainer.getHost(),
                jdbcContainer.getFirstMappedPort());
  ...
  public void onFinish(ISuite suite) {
    ...
    if (jdbcContainer != null) jdbcContainer.close();
    if (h2Server != null) h2Server.stop();
    logger.debug("onFinish");
  }

  private JdbcDatabaseContainer<?> createJdbcContainer(
      String dbType, String initScript, String dbUser, String dbPswd, String dbName, String image) {
