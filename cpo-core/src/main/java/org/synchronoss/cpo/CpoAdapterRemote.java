...
public interface CpoAdapterRemote extends java.io.Serializable {
  ...
  /**
   * Clears the metadata for the specified object. The metadata will be reloaded the next time that this object is
   * loaded by dataPersist.
   *
   * @param obj The object whose metadata must be cleared
   *
   * @throws CpoException Thrown if there are errors accessing the datasource
   * @throws RemoteException Thrown if using dataPersist as an EJB and an Error occurs.
   */
  public void clearMetaClass(Object obj) throws CpoException, RemoteException;

  /**
   * Clears the metadata for the specified fully qualifed class name. The metadata will be reloaded the next time that
   * this class is loaded by dataPersist.
   *
   * @param className The fully qualified class name for the class that needs its metadata cleared.
   *
   * @throws CpoException Thrown if there are errors accessing the datasource
   * @throws RemoteException Thrown if using dataPersist as an EJB and an Error occurs.
   */
  ...
  /**
   * Clears the metadata for all classes. The metadata will be lazy-loaded from the metadata repository as classes are
   * accessed.
   *
   * @throws CpoException Thrown if there are errors accessing the datasource
   * @throws RemoteException Thrown if using dataPersist as an EJB and an Error occurs.
   ...
   *
   * @param obj This is an
   * <code>Object</code> that has been defined within the metadata of the datasource. If the class is not defined an
   * exception will be thrown. If the object does not exist in the datasource, an exception will be thrown. This object
   * is used to populate the IN parameters used to executed the datasource object.
   *
