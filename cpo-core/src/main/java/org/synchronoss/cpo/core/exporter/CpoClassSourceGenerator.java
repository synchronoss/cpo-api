...
public class CpoClassSourceGenerator extends AbstractMetaVisitor {
   ...
   *
   * @return the name of the last class generated by {@link #visit(CpoClass)}, or {@code null} if
   ...
   *
   * @return the full generated Java source for the class last visited by {@link #visit(CpoClass)}
   */
