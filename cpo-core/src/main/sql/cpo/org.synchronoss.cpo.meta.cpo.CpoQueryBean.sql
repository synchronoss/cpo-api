delete from CPO_QUERY_PARAMETER  where query_id in (select distinct query_id from CPO_QUERY where group_id in (select distinct group_id from CPO_QUERY_GROUP where class_id=(select class_id from CPO_CLASS where name='org.synchronoss.cpo.meta.cpo.CpoQueryBean')));
delete from CPO_QUERY where group_id in (select distinct group_id from CPO_QUERY_GROUP where class_id=(select class_id from CPO_CLASS where name='org.synchronoss.cpo.meta.cpo.CpoQueryBean'));
...
delete from CPO_QUERY_GROUP where class_id=(select class_id from CPO_CLASS where name='org.synchronoss.cpo.meta.cpo.CpoQueryBean');
delete from CPO_ATTRIBUTE_MAP where class_id=(select class_id from CPO_CLASS where name='org.synchronoss.cpo.meta.cpo.CpoQueryBean');
delete from CPO_CLASS where name='org.synchronoss.cpo.meta.cpo.CpoQueryBean';
...
insert into cpo_class (class_id, name, userid) values ('0c97c7ec-0a0e-1e64-0c4c-7e106c41528b','org.synchronoss.cpo.meta.cpo.CpoQueryBean','dberry');
...
insert into cpo_attribute_map (attribute_id, class_id, column_name, attribute, column_type, db_column, db_table,transform_class, userid) values ('0c97c7ed-0a0e-1e64-0c4c-7e104eb94edd','0c97c7ec-0a0e-1e64-0c4c-7e106c41528b','QUERY_ID','queryId','VARCHAR',null,null,null,'dberry');
...
insert into cpo_attribute_map (attribute_id, class_id, column_name, attribute, column_type, db_column, db_table,transform_class, userid) values ('0c97c7ed-0a0e-1e64-0c4c-7e103d3f115b','0c97c7ec-0a0e-1e64-0c4c-7e106c41528b','TEXT_ID','textId','VARCHAR',null,null,null,'dberry');
