...
insert into cpo_query_text (text_id, sql, description) values ('256d3c3d-0a07-3238-018c-6cbc94b4d4a6','insert into lob_test (lob_id, b_lob, c_lob) values (?,?,?)','createLVO');
update cpo_query_text set sql = 'insert into lob_test (lob_id, b_lob, c_lob) values (?,?,?)', description = 'createLVO' where text_id = '256d3c3d-0a07-3238-018c-6cbc94b4d4a6';
insert into cpo_query_text (text_id, sql, description) values ('256e1b1d-0a07-3238-018c-6cbce874a3b8','delete from lob_test where lob_id = ?','deleteLVO');
update cpo_query_text set sql = 'delete from lob_test where lob_id = ?', description = 'deleteLVO' where text_id = '256e1b1d-0a07-3238-018c-6cbce874a3b8';
insert into cpo_query_text (text_id, sql, description) values ('256dbf37-0a07-3238-018c-6cbcc297d3f3','select * from lob_test where lob_id = ?','retrieveLVO');
update cpo_query_text set sql = 'select * from lob_test where lob_id = ?', description = 'retrieveLVO' where text_id = '256dbf37-0a07-3238-018c-6cbcc297d3f3';
insert into cpo_query_text (text_id, sql, description) values ('256d8789-0a07-3238-018c-6cbc9d297be4','update lob_test set b_lob=?, c_lob=? where lob_id = ?','updateLVO');
update cpo_query_text set sql = 'update lob_test set b_lob=?, c_lob=? where lob_id = ?', description = 'updateLVO' where text_id = '256d8789-0a07-3238-018c-6cbc9d297be4';
...
insert into cpo_query_group (group_id, class_id, type, name) values ('256c228c-0a07-3238-018c-6cbc8f38ab75','2563f7ef-0a07-3238-018c-6cbc1b949eab','CREATE','createLVO');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563f899-0a07-3238-018c-6cbc07ebc5b1','256e3097-0a07-3238-018c-6cbcbe7cde0b','1','IN');
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563fb80-0a07-3238-018c-6cbc7b29779d','256e3097-0a07-3238-018c-6cbcbe7cde0b','2','IN');
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563fb8a-0a07-3238-018c-6cbc1bcd0ed8','256e3097-0a07-3238-018c-6cbcbe7cde0b','3','IN');
insert into cpo_query_group (group_id, class_id, type, name) values ('256cfe18-0a07-3238-018c-6cbcccff836a','2563f7ef-0a07-3238-018c-6cbc1b949eab','DELETE','deleteLVO');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563f899-0a07-3238-018c-6cbc07ebc5b1','2571de03-0a07-3238-018c-6cbc4cecaa2c','1','IN');
insert into cpo_query_group (group_id, class_id, type, name) values ('256ccd08-0a07-3238-018c-6cbc75b1a4d4','2563f7ef-0a07-3238-018c-6cbc1b949eab','RETRIEVE','retrieveLVO');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563f899-0a07-3238-018c-6cbc07ebc5b1','2571626e-0a07-3238-018c-6cbc1ac0c41e','1','IN');
insert into cpo_query_group (group_id, class_id, type, name) values ('256c9a30-0a07-3238-018c-6cbc88836bd6','2563f7ef-0a07-3238-018c-6cbc1b949eab','UPDATE','updateLVO');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563fb80-0a07-3238-018c-6cbc7b29779d','256fe070-0a07-3238-018c-6cbc92919eae','1','IN');
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563fb8a-0a07-3238-018c-6cbc1bcd0ed8','256fe070-0a07-3238-018c-6cbc92919eae','2','IN');
insert into cpo_query_parameter (attribute_id, query_id, seq_no,type) values ('2563f899-0a07-3238-018c-6cbc07ebc5b1','256fe070-0a07-3238-018c-6cbc92919eae','3','IN');
