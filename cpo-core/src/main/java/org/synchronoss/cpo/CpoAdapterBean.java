...
public class CpoAdapterBean
  ...
  /**
   * Creates the Object and stores it in the datasource. The assumption is that the object does not exist in the
   * datasource.
   *
  ...
  /**
   * Iterates through a collection of Objects, creates them and stores them in the datasource. The assumption is that
   * the objects contained in the collection do not exist in the datasource.
   *
   * This method creates and stores the objects in the datasource. The objects in the collection will be treated as one
   * transaction, meaning that if one of the objects fail being created in the datasource then the entire collection
   * will be rolled back
   *
   ...
   * will be rolled back
   *
   * @param name The the context name for which group of operations will be called to process this insert.
   * @param coll This is a collection of objects that have been defined within the metadata of the datasource. If the
   * class is not defined an exception will be thrown.
   */
  @Override
   ...
   * defined an exception will be thrown. If the object does not exist in the datasource, an exception will be thrown.
   * This object is used to specify the parameters used to retrieve the collection of objects.
  ...
  /**
   * Persists the Object into the datasource. The assumption is that the object exists in the datasource.
   *
  ...
  /**
   * Persists a collection of Objects into the datasource. The assumption is that the objects contained in the
   * collection exist in the datasource.
   *
   * This method stores the object in the datasource. The objects in the collection will be treated as one transaction,
   * meaning that if one of the objects fail being updated in the datasource then the entire collection will be rolled
   * back.
   *
  ...
  /**
   * Removes the Object from the datasource. The assumption is that the object exists in the datasource.
   *
   * This method stores the object in the datasource
   *
   * @param obj This is an object that has been defined within the metadata of the datasource. If the class is not
   ...
   * the datasource.
   *
   * This method stores the objects contained in the collection in the datasource. The objects in the collection will be
   * treated as one transaction, meaning that if one of the objects fail being deleted from the datasource then the
   ...
   * @param result This is an object that has been defined within the metadata of the datasource. If the class is not
   * defined an exception will be thrown. If the object does not exist in the datasource, an exception will be thrown.
   * This object defines the object type that will be returned in the collection and contain the result set data or the
   * OUT Parameters.
   * @param name The filter name which tells the datasource which objects should be returned. The name also signifies
   * what data in the object will be populated.
   *
