...
public class CpoAttribute extends CpoAttributeBean {
  ...
  private CpoAttribute() {
    ...
    public <T> CpoAttribute(CpoClass<T> jmc, String name, String dataName, String transformClass)
    throws CpoException {
    ...
    static protected <T> Method[] findMethods(CpoClass<T> jmc, String methodName, int args, boolean hasReturn)
    throws CpoException{
        Method m[] = null;
        int count = 0;
        int idx[] = null;
