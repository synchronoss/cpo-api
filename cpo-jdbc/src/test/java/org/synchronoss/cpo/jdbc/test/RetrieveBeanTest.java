...
public class RetrieveBeanTest {
  ...
  public void setUp() {
    ...
    ValueObject vo = ValueObjectFactory.createValueObject(41, className);
    vo.setAttrVarChar("Test");
    al.add(vo);
    al.add(ValueObjectFactory.createValueObject(42, className));
    al.add(ValueObjectFactory.createValueObject(43, className));
    al.add(ValueObjectFactory.createValueObject(44, className));
    al.add(ValueObjectFactory.createValueObject(45, className));
    al.add(ValueObjectFactory.createValueObject(46, className));
    al.add(ValueObjectFactory.createValueObject(47, className));
    al.add(ValueObjectFactory.createValueObject(48, className));
    al.add(ValueObjectFactory.createValueObject(49, className));
    al.add(ValueObjectFactory.createValueObject(50, className));
    try {
  ...
  public void testRetrieveBeansNoWaitSize2() {
    ...
    try {
      ...
      assertEquals(al.size(), count, "Result size is " + count);
  ...
  public void testNullRetrieveBean() {
    ...
    ValueObject vo = ValueObjectFactory.createValueObject(100, className);
    ValueObject rvo;
