...
insert into cpo_query_text (text_id, sql_text, description) values ('256d3c3d-0a07-3238-018c-6cbc94b4d4a6','insert into lob_test (lob_id, b_lob, c_lob, b_lob2) values (?,?,?,?)','createLVO');
update cpo_query_text set sql_text = 'insert into lob_test (lob_id, b_lob, c_lob, b_lob2) values (?,?,?,?)', description = 'createLVO' where text_id = '256d3c3d-0a07-3238-018c-6cbc94b4d4a6';
...
insert into cpo_query_text (text_id, sql_text, description) values ('256d8789-0a07-3238-018c-6cbc9d297be4','update lob_test set b_lob=?, c_lob=?, b_lob2=? where lob_id = ?','updateLVO');
update cpo_query_text set sql_text = 'update lob_test set b_lob=?, c_lob=?, b_lob2=? where lob_id = ?', description = 'updateLVO' where text_id = '256d8789-0a07-3238-018c-6cbc9d297be4';
insert into cpo_class (class_id, name) values ('2563f7ef-0a07-3238-018c-6cbc1b949eab','org.synchronoss.cpo.jdbc.LobValueObject');
insert into cpo_attribute_map (attribute_id, class_id, column_name, attribute, column_type, db_column, db_table,transform_class) values ('2563fb80-0a07-3238-018c-6cbc7b29779d','2563f7ef-0a07-3238-018c-6cbc1b949eab','b_lob','bLob','LONGVARBINARY',null,null,'org.synchronoss.cpo.transform.jdbc.TransformGZipBytes');
insert into cpo_attribute_map (attribute_id, class_id, column_name, attribute, column_type, db_column, db_table,transform_class) values ('f3af5c6e-0a07-2346-010d-4f27016a1707','2563f7ef-0a07-3238-018c-6cbc1b949eab','b_lob2','bLob2','LONGVARBINARY',null,null,'');
insert into cpo_attribute_map (attribute_id, class_id, column_name, attribute, column_type, db_column, db_table,transform_class) values ('2563fb8a-0a07-3238-018c-6cbc1bcd0ed8','2563f7ef-0a07-3238-018c-6cbc1b949eab','c_lob','cLob','LONGVARCHAR',null,null,'org.synchronoss.cpo.transform.jdbc.TransformStringChar');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,param_type) values ('f3af5c6e-0a07-2346-010d-4f27016a1707','256e3097-0a07-3238-018c-6cbcbe7cde0b','4','IN');
...
insert into cpo_query_parameter (attribute_id, query_id, seq_no,param_type) values ('f3af5c6e-0a07-2346-010d-4f27016a1707','256fe070-0a07-3238-018c-6cbc92919eae','3','IN');
insert into cpo_query_parameter (attribute_id, query_id, seq_no,param_type) values ('2563f899-0a07-3238-018c-6cbc07ebc5b1','256fe070-0a07-3238-018c-6cbc92919eae','4','IN');
