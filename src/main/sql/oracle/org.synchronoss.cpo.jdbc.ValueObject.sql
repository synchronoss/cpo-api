delete from TEST_CPO_QUERY_PARAMETER  where query_id in (select distinct query_id from TEST_CPO_QUERY where group_id in (select distinct group_id from TEST_CPO_QUERY_GROUP where class_id=(select class_id from TEST_CPO_CLASS where name='org.synchronoss.cpo.jdbc.ValueObject')))
/
delete from TEST_CPO_QUERY where group_id in (select distinct group_id from TEST_CPO_QUERY_GROUP where class_id=(select class_id from TEST_CPO_CLASS where name='org.synchronoss.cpo.jdbc.ValueObject'))
/
delete from TEST_CPO_QUERY_GROUP where class_id=(select class_id from TEST_CPO_CLASS where name='org.synchronoss.cpo.jdbc.ValueObject')
/
delete from TEST_CPO_ATTRIBUTE_MAP where class_id=(select class_id from TEST_CPO_CLASS where name='org.synchronoss.cpo.jdbc.ValueObject')
/
delete from TEST_CPO_CLASS where name='org.synchronoss.cpo.jdbc.ValueObject'
/
